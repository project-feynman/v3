<template>
  <v-container>
    <h1>This "Get Started" page has been deprecated, please visit the home page directly at explain.mit.edu</h1>
    <!-- <v-btn @click="isPopupOpen = !isPopupOpen">Toggle popup</v-btn>
    <v-dialog v-model="isPopupOpen" persistent>
      <v-card height="300">
        <p>HELLO WORLD</p>
        <v-btn @click="isPopupOpen = false">CANCEL</v-btn>
      </v-card>
    </v-dialog>
